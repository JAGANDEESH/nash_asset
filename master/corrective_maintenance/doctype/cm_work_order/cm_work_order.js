        ...
        function renderedListOfCmWorkOrder(frm) {
            ...
            button[type="button"] {
                ...
                $(document).on('click', '#addspare', function() {
                    let table = $(this).closest('.form-container').find('#sparesTable tbody')[0];
                ...
                $(document).on('click', '#removelist', function() {
                    ...
                    frm.get_field('list_cm_work_order_add').grid.grid_rows[rowIndex].remove();
                    frm.refresh_field('list_cm_work_order_add');
                });
